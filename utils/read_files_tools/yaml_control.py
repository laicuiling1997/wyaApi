...
if __name__ == '__main__':
    file = ensure_path_sep("\\data\\login.yaml")
    # print(file,'====')
    getYaml = GetYamlData(file)
    tryData = GetCaseData(getYaml)
    # print(tryData)
    print(tryData.get_different_formats_yaml_data())
    # print(tryData.get_yaml_case_data())